<div class="container-fluid">
			...
			<p class="lead">Por favor ingrese el nombre del curso y seleccione el grado y la carrera ala que pertenece</p>
		</div>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12">
								    	<div class="form-group label-floating">
										  	...
										  	<input pattern="[a-zA-Z0-9-]{1,30}" class="form-control" type="text" name="curso" required="" maxlength="30">
										</div>
				    				</div>
